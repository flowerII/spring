	...
	<head>
		...
		<script type="text/javascript">
                   	$._ajax({
						...
						$('.content-main').html(activity.activity_description)
						$('h3').html(activity.activity_name)
						$('title').html(activity.activity_name)
						$('#start span').html(getTime(activity.activity_starttime))
						$('#end span').html(getTime(activity.activity_endtime))
					})
		...
		<div class="container">
			<div class="panel">
				<div class="panel-heading">
					<h3></h3>
					<p id="start">开始时间：<span></span></p>
					<p id="end">结束时间：<span></span></p>
				</div>
